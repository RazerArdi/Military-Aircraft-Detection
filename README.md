...
| **5.** | **Sistem Website**      | **Streamlit Web App** (Local & Cloud).<br>Fitur: Input Gambar/Video, Real-time Inference, Tactical HUD.<br>🔗 **[Live Demo](https://huggingface.co/spaces/SlRazer/MLPrak)** | ✅     |
